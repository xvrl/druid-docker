...
sed -ri 's#druid.google.bucket.*#druid.google.bucket='${GOOGLE_STORAGE_BUCKET}'#g' /opt/druid/conf/druid/_common/common.runtime.properties
sed -ri 's#druid.google.prefix.*#druid.google.prefix='${GOOGLE_STORAGE_PREFIX}'#g' /opt/druid/conf/druid/_common/common.runtime.properties
sed -ri 's#druid.indexer.logs.bucket.*#druid.indexer.logs.bucket='${GOOGLE_INDEXING_BUCKET}'#g' /opt/druid/conf/druid/_common/common.runtime.properties
sed -ri 's#druid.indexer.logs.prefix.*#druid.indexer.logs.prefix='${GOOGLE_INDEXING_PREFIX}'#g' /opt/druid/conf/druid/_common/common.runtime.properties
